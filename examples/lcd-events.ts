...
streamDeck.onLcdTap('dial_1', params => {
    console.log(`Dial 1 tapped at ${params.tapPosition.x}, ${params.tapPosition.y}`);
});

streamDeck.onLcdHold('dial_1', params => {
    console.log(`Dial 1 held at ${params.tapPosition.x}, ${params.tapPosition.y}`);
});
